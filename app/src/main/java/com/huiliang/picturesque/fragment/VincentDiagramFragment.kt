...
import com.huiliang.picturesque.BuildConfig
...
import com.huiliang.picturesque.databinding.FragmentVincentDiagramBinding
import com.huiliang.picturesque.util.ApkInstaller
...
class VincentDiagramFragment : BaseFragment<AiViewModel, FragmentVincentDiagramBinding>() {
    ...
    private fun handleDownloadComplete(filePath: String) {
        ...
        context?.let { ApkInstaller.installApk(it, filePath) }
    }
}